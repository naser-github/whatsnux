...
- `doc/requirement.md`: product requirements
- `doc/architecture.md`: implementation architecture
- `doc/agent-plan.md`: agent roles and model split
- `doc/roadmap.md`: milestones
- `doc/test-plan.md`: validation checklist
